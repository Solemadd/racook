...
<html lang="en" class="light_body">
  <head>
    ...
    <main class="param">
        <br>
        <button><h2>Mon compte</h2><img src="img/param.png" alt="roue des paramètres"></button>
        <button><h2>Mes recettes</h2><img src="img/param.png" alt="roue des paramètres"></button>
        <button><h2>Mon frigo</h2><img src="img/param.png" alt="roue des paramètres"></button>
    </main>
